        ...
        <div className="py-10 px-5 text-slate-100 sm:grid sm:grid-cols-2 sm:gap-x-12 sm:px-24 sm:items-start">
          <div>
            <h2 className="text-2xl font-bold mb-4">
              Selamat datang Promo IndiHome di IndiHome by-Telkomsel. Cek promo
              terbaru dan segera daftar untuk menikmati koneksi internet cepat,
              tayangan TV berkualitas, dan layanan telepon rumah dari indiHome
            </h2>
            <p>
