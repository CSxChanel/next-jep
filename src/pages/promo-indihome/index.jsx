...
const PromoIndihome = () => {
    ...
    return (
        <>
            <Head>
                <title>
                    Indihome by-Telkomsel | Promo IndiHome - Penawaran Spesial
                    Layanan Internet, TV, dan Telepon
                </title>
                <meta
                    name="description"
                        ...
                        <div className="py-10 px-5 text-slate-100 sm:grid sm:grid-cols-2 sm:gap-x-12 sm:px-24 sm:items-start">
                            <div>
                                <h2 className="text-2xl font-bold mb-4">
                                    Selamat datang Promo IndiHome di IndiHome
                                    by-Telkomsel. Cek promo terbaru dan segera
                                    daftar untuk menikmati koneksi internet
                                    cepat, tayangan TV berkualitas, dan layanan
                                    telepon rumah dari indiHome
                                </h2>
                                <p>
                                    IndiHome menghadirkan berbagai paket promo
                                    menarik untuk memenuhi kebutuhan internet
                                    Anda. Paket-paket ini dirancang untuk
                                    memberikan pengalaman internet yang cepat,
                                    stabil, dan terjangkau. Namun, perlu diingat
                                    bahwa tidak semua paket promo tersedia di
                                    setiap wilayah. Oleh karena itu, penting
                                    untuk memeriksa ketersediaan paket di daerah
                                    Anda.
                                </p>
                            </div>
                            <div>
                                <h3 className="text-[20px] mt-8 leading-8 font-semibold">
                                    Untuk informasi lebih lanjut mengenai paket
                                    promo dan ketersediaan di wilayah Anda,
                                    hubungi Marketing IndiHome, Pilih Produk
                                    Chat via WhatApp. Pastikan Anda mendapatkan
                                    informasi dari sumber resmi untuk
                                    menghindari penipuan dan informasi yang
                                    salah.
                                </h3>
                            </div>
                        </div>
