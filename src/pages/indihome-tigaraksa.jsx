...
function Tigaraksa() {
  ...
  const tigaraksa = {
    ...
    pageTitle:
      "IndiHome Tigaraksa | Pendaftaran Online area tigaraksa by-Telkomsel",
    description:
      "Untuk Sobat indihome wilayah Indihome-tigaraksa dapat Registrasi atau Pendaftaran Online juga bisa menghubungi Marketing resmi indihome. ada banyak pilihat paket promo untuk wilayah tigaraksa. segera daftar dan nikmati layanan internet terbaik dari indihome-tigaraksa.",
    h2Title:
      ...
      {loading ? (
        ...
        <>
          <Banner
            ...
            h2Title={tigaraksa.h2Title}
          />
          <H3Title title={tigaraksa.title} path={tigaraksa.path} />
          <InternetPromo
            title={tigaraksa.title}
            path={tigaraksa.path}
