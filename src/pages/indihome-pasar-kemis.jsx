...
function PasarKemis() {
  ...
  const pageUrl = `https://indihome-bytelkomsel.com/${pasarkemis.path}`;
      ...
      {loading ? (
        ...
        <>
          <Banner
            ...
            h2Title={pasarkemis.h2Title}
          />
          <H3Title title={pasarkemis.title} path={pasarkemis.path} />
          <InternetPromo
            title={pasarkemis.title}
