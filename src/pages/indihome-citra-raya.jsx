...
function CitraRaya() {
  ...
  const citraraya = {
    ...
    pageTitle:
      "IndiHome Citra Raya | Registrasi indihome citra-raya by-Telkomsel",
    description:
  ...
  const pageUrl = `https://indihome-bytelkomsel.com/${citraraya.path}`;
      ...
      {loading ? (
        ...
        <>
          <Banner
            ...
            h2Title={citraraya.h2Title}
          />
          <H3Title title={citraraya.title} path={citraraya.path} />
          <InternetPromo
            title={citraraya.title}
            path={citraraya.path}
