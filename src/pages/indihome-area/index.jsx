...
const IndihomeAreaList = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Indihome Area | Provider internet mencakup semua area indihome biaya
          registrasi Gratis.
        </title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Indihome Area | Provider internet mencakup semua area indihome biaya registrasi Gratis."
        />
        <meta
