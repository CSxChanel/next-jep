...
const IndihomeAreaList = () => {
    ...
    return (
        <>
            <Head>
                <title>
                    IndiHome by-Telkomsel | Area IndiHome Biaya Registrasi
                    Gratis
                </title>
                <meta
                    name="description"
                    content="Area IndiHome mencakup semua wilayah Indonesia, dengan biaya registrasi gratis dan layanan internet fiber Optik terbaik. Dapatkan koneksi internet terbaik di seluruh wilayah Indonesia, mulai dari wilayah di Jawa Timur, Jawa Tengah, Jawa Barat,Banten, Lampung, hingga wilayah di DKI Jakarta dan sekitarnya."
                />
                ...
                <meta
                    property="og:title"
                    content="IndiHome by-Telkomsel | Area IndiHome Biaya Registrasi Gratis"
                />
                <meta
                    property="og:description"
                    content="Indihome by-Telkomsel, indihome suda tersedia di seluruh penjuru pelosok, lebih dari 8++juta pelanggan Aktif. menghadirkan layanan internet fiber Optik."
                />
